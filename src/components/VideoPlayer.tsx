      ...
      >
        ...
        <div className="flex items-center justify-between text-xs sm:text-sm font-medium text-slate-200">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            {/* Cinema Fullscreen Mode trigger */}
            {onOpenCinemaMode && (
              <button
                id="btn-trigger-cinema-mode"
                onClick={onOpenCinemaMode}
                className="p-1.5 rounded-lg hover:bg-rose-500/20 text-rose-300 hover:text-white transition-all"
                title="Mở Rạp Chiếu Toàn Màn Hình Tối Ưu (Cinema Mode)"
              >
